...
{
    public partial class SaleQt: Form
    {
      ...
      double  pricefob=0;
        ...
        public SaleQt(string DocNo)
        {
            ...
            rateTable = Model.DbFunctions.GetDataTable(query);
        ...
        public SaleQt(string ccode, string cname, string netamt, string tamt, string disc, string qno)
        {
            InitializeComponent();
            decimalFormat = Common.getDecimalFormat();
            BindSettings();
        ...
        public void bindQtgridview(string VOUCHNO)
        {
           // conn.Open();
            string qry = "";
            qry = "SELECT * FROM INV_SAL_ORD_DTL WHERE DOC_ID = '" + VOUCHNO + "'";
            //cmd.CommandType = CommandType.Text;
            SqlDataReader r = Model.DbFunctions.GetDataReader(qry);
            while (r.Read())
            {
        ...
        public SaleQt(string docType, string prefix)
        {
            InitializeComponent();
            decimalFormat = Common.getDecimalFormat();
            BindSettings();
            ...
            //adapter.Fill(rateTable);
            rateTable = Model.DbFunctions.GetDataTable(query);
            RATE_CODE.SelectedIndexChanged -= RATE_CODE_SelectedIndexChanged;
            RATE_CODE.DisplayMember = "value";
            RATE_CODE.ValueMember = "key";
            RATE_CODE.DataSource = rateTable;
            RATE_CODE.SelectedIndexChanged += RATE_CODE_SelectedIndexChanged;
        ...
        private void getDetails()
        {
            string qry = "";
            table.Rows.Clear();
            qry = "SELECT * FROM viewSalesHDR";
            //cmd.CommandType = CommandType.Text;
            //adapter.Fill(table);
            table = Model.DbFunctions.GetDataTable(qry);
        ...
        public void BindBatchTable()
        {
            ...
            string cmd = "itemSuggestion_test";
            table_for_batch = Model.DbFunctions.GetDataTableProcedure(cmd);
        ...
        public void bindgridview()
        {
            try
            {
                ...
                ////cmd.CommandText = "ItemSuggestion";
                //// cmd.CommandText = "itemSuggestion_test";
                string cmd = "item_suggestion_for_sales";
                //cmd.CommandType = CommandType.StoredProcedure;
                //adapter.SelectCommand = cmd;
                //adapter.Fill(productDataTable);
               // cmd.CommandType = CommandType.Text;
               // //dataGridItem.DataSource = productDataTable;
                productDataTable = Model.DbFunctions.GetDataTableProcedure(cmd);
        ...
        public void GetMaxDocID()
        {
            ...
            string query = "SELECT ISNULL(MAX(DOC_ID), 0) FROM INV_SAL_ORD_HDR";
                //cmd.CommandType = CommandType.Text;
                ...
                //}
                //conn.Open();
                value = Convert.ToString(Model.DbFunctions.GetAValue(query));
            ...
            {
                string command = "SELECT InvoiceStart FROM GEN_INV_STARTFROM WHERE InvoiceTypeCode='" + cmbInvType.SelectedValue + "'";
                //cmd.CommandType = CommandType.Text;
                //conn.Open();
                Billno = VOUCHNUM.Text = Convert.ToString(DbFunctions.GetAValue(command));
                //conn.Close();
            }
            else
            {
        ...
        {
           // cmd.Connection = conn;
            string command = "SELECT TaxId, CODE + ' --- ' +CONVERT(varchar(10),TaxRate)+' %' AS Expr1 FROM GEN_TAX_MASTER";
            //cmd.CommandType = CommandType.Text;
            DataTable dt = new DataTable();
            //SqlDataAdapter SQ = new SqlDataAdapter(cmd);
            //SQ.Fill(dt);
            dt = DbFunctions.GetDataTable(command);
        ...
        {
            //cmd.Connection = conn;
            string command = "SELECT CODE,DESC_ENG  FROM INV_UNIT";
            //cmd.CommandType = CommandType.Text;
            //SqlDataAdapter SQ1 = new SqlDataAdapter(cmd);
            DataTable dt1 = new DataTable();
            //SQ1.Fill(dt1);
            dt1=DbFunctions.GetDataTable(command);
        ...
        public void getValue()
        {
            DataTable dt = new DataTable();
            //cmd.Connection = conn;
            string command = "SELECT Free, Mrp, GrossValue, NetValue, Description FROM SYS_SETUP";
            //cmd.CommandType = CommandType.Text;
        ...
        public void BindCurrency()
        {
            DataTable dt = new DataTable();
            //cmd.Connection = conn;
            string command = "SELECT * FROM GEN_CURRENCY";
            //cmd.CommandType = CommandType.Text;
            //SqlDataAdapter adapter = new SqlDataAdapter(cmd);
            //adapter.Fill(dt);
            dt = DbFunctions.GetDataTable(command);
        ...
        private void btnDocNo_Click(object sender, EventArgs e)
        {
            ...
            if (h.ShowDialog() == DialogResult.OK && h.c != null)
            {
                ...
                //conn.Open();
                string command = "SELECT * FROM INV_SALES_DTL WHERE DOC_NO = '" + DOC_NO.Text + "'";
                //cmd.CommandType = CommandType.Text;
                SqlDataReader r = DbFunctions.GetDataReader(command);
                while (r.Read())
                {
                    int i = dgItems.Rows.Add(new DataGridViewRow());
                    DataGridViewCellCollection c = dgItems.Rows[i].Cells;
        ...
        public void GetInvoiceType()
        {
            //conn.Open();
            string cmds = "";
            cmds ="SELECT SALE_TYPE FROM INV_SALES_HDR WHERE DOC_NO = '" + DOC_NO.Text + "'";            
            string value = Convert.ToString(DbFunctions.GetAValue(cmds));
            cmds = "SELECT DESC_ENG FROM GEN_SALE_TYPE WHERE CODE ='"+value+"'";
            string data = Convert.ToString(DbFunctions.GetAValue(cmds));
            //conn.Close();    
        ...
        public void getdatafromDocNo()
        {
            ...
            //conn.Open();
            string command = "";
            command = "SELECT * FROM INV_SALES_HDR WHERE DOC_NO = '" + DOC_NO.Text + "'";
            //cmd.CommandType = CommandType.Text;
            SqlDataReader rd = DbFunctions.GetDataReader(command);
            while (rd.Read())
            {
            ...
            command = "SELECT dtl.*, PAY_SUPPLIER.DESC_ENG AS supplier_name, g.DESC_ENG AS [Group] FROM INV_SALES_DTL as dtl LEFT JOIN PAY_SUPPLIER ON dtl.supplier_id = PAY_SUPPLIER.CODE LEFT JOIN INV_ITEM_GROUP as g ON dtl.group_id = g.CODE WHERE DOC_NO = '" + DOC_NO.Text + "'AND FLAGDEL='TRUE'";
            //cmd.CommandType = CommandType.Text;
            SqlDataReader r = DbFunctions.GetDataReader(command);
            while (r.Read())
            {
        ...
        {
            //conn.Open();
            string command = "SELECT GEN_DISCOUNT_TYPE.VALUE, GEN_DISCOUNT_TYPE.TYPE AS Type FROM            REC_CUSTOMER_TYPE INNER JOIN REC_CUSTOMER ON REC_CUSTOMER_TYPE.CODE = REC_CUSTOMER.TYPE INNER JOIN  GEN_DISCOUNT_TYPE ON REC_CUSTOMER_TYPE.DISCOUNT_TYPE = GEN_DISCOUNT_TYPE.CODE WHERE        (REC_CUSTOMER.CODE ='" + CUS_CODE + "')";
            //cmd.CommandType = CommandType.Text;
            SqlDataReader r = DbFunctions.GetDataReader(command);
            while (r.Read())
            {
        ...
        {
            //conn.Open();
            string comand = "SELECT TaxRate from GEN_TAX_MASTER where TaxId=" + TaxId;
            //cmd.CommandType = CommandType.Text;
            SqlDataReader r = DbFunctions.GetDataReader(comand);
            while (r.Read())
            {
            ...
            try
            {
                ...
                if (CheckItemStokOut())
                {
                    if (itemValid())
                    {
                        ...
                        {
                            BarcodeFlag = false;
                            string t = purcalculation(ITEM_CODE.Text, Convert.ToInt32(c["cQty"].Value));
                            ...
                            try
                            {
                                ...
                                if (pr == 0)
                                {
                                    ...
                                    //conn.Open();
                                    //cmd.CommandType = CommandType.Text;
                                    string command = "select PRICE FROM INV_ITEM_PRICE WHERE SAL_TYPE='PUR' AND ITEM_CODE='" + ITEM_CODE.Text + "'";
                                    result = Convert.ToString(DbFunctions.GetAValue(command));
        ...
        private void dgItems_Click(object sender, EventArgs e)
        {
            ...
            if (dgItems.Rows.Count > 0 && dgItems.CurrentRow != null)
            {
                ...
                string cmd = "SELECT HASSERIAL FROM INV_ITEM_DIRECTORY WHERE CODE='" + Convert.ToString(c["cCode"].Value) + "'";
                //SqlDataAdapter adapter = new SqlDataAdapter(cmd);
                //adapter.Fill(dt);
                dt = DbFunctions.GetDataTable(cmd);
        ...
        private void calculateGrossAmount(object sender, EventArgs e)
        {
            try
            {
                if (QUANTITY.Text.Trim() != "" && PRICE.Text.Trim() != "")
                {
                    ...
                    tb_netvalue.Text = ((Convert.ToDouble(QUANTITY.Text) * Convert.ToDouble(PRICE.Text)) - Convert.ToDouble(DiscAmt)).ToString(decimalFormat);
                }
                //----OLD CODE -----///
                if (BARCODE.Text.Trim() != "")
                {
                    //Int32 qty = Convert.ToInt32(QUANTITY.Text);
                    //cmd.Connection = conn;
                    //cmd.CommandText = "SELECT Price,Qty from RateChange  where R_Id='" + BARCODE.Text + "'";
                    //cmd.CommandType = CommandType.Text;
                    ...
                    //    string qua = dt.Rows[0]["Qty"].ToString();
                    //    if (Convert.ToDecimal(qua) >= qty)
                    //    {
                    //        pur_price = Convert.ToDecimal(price) * Convert.ToDecimal(qty);
                    //    }
                    //    else
                    //    {
                    //        MessageBox.Show("out of Stock Quantity " + qua + " Items Only");
                    //        decimal balqty = qty - Convert.ToDecimal(qua);
                    //        QUANTITY.Text = qua.ToString();
        ...
        private void addUnits()
        {
            unitsTable.Rows.Clear();
            //cmd.Connection = conn;
            string query = "SELECT UNIT_CODE, PACK_SIZE FROM INV_ITEM_DIRECTORY_UNITS WHERE ITEM_CODE = '" + ITEM_CODE.Text + "'";
            ///cmd.CommandType = CommandType.Text;
            //adapter = new SqlDataAdapter(cmd);
            //adapter.Fill(unitsTable);
            unitsTable = DbFunctions.GetDataTable(query);
        ...
        public double creditamt()
        {
            double data = 0;
            DataTable dt = new DataTable();
            string query = "SELECT     SUM(DEBIT)-SUM(CREDIT)  AS creditamt FROM         tb_Transactions WHERE     (ACCNAME = '" + CASHACC.Text + "') AND (ACCID = '" + CASHACC.SelectedValue + "')";
            //cmd.CommandType = CommandType.Text;
            //adapter.Fill(dt);
            dt = DbFunctions.GetDataTable(query);
            if (dt.Rows.Count > 0)
        ...
        public double GetCustomerCreditLimit()
        {
            double data = 0;
            DataTable dt = new DataTable();
            string query = "SELECT     REC_CUSTOMER_TYPE.CREDIT_LEVEL FROM         REC_CUSTOMER INNER JOIN REC_CUSTOMER_TYPE ON REC_CUSTOMER.TYPE = REC_CUSTOMER_TYPE.CODE WHERE     (REC_CUSTOMER.CODE = '" + CUSTOMER_CODE.Text + "')";
            //cmd.CommandType = CommandType.Text;
            //adapter.Fill(dt);
            dt = DbFunctions.GetDataTable(query);
            if (dt.Rows.Count > 0)
        ...
        public string saledtlChecker(string code, string inv)
        {
            string qty = "";
            //cmd.Connection = conn;
            string query = "select QUANTITY from INV_SALES_DTL where ITEM_CODE='" + code + "' AND DOC_ID='" + inv + "' ";
            //cmd.CommandType = CommandType.Text;
            //SqlDataAdapter Adap = new SqlDataAdapter();
            //Adap.SelectCommand = cmd;
            DataTable dt = new DataTable();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (valid())
            {
                ...
                if (ID == "")
                {
                    DOC_NO.Text = General.generateSalesQtID();
                    ...
                    query = "INSERT INTO INV_SAL_ORD_HDR(DOC_ID,DOC_NO,DOC_TYPE,DOC_DATE_GRE,DOC_DATE_HIJ,CURRENCY_CODE,DOC_REFERENCE,CUSTOMER_CODE,CUSTOMER_NAME_ENG,SALESMAN_CODE,NOTES,TAX_TOTAL,VAT,DISCOUNT,TOTAL_AMOUNT,PAY_CODE,CARD_NO,FREIGHT,ROUNDOFF,CESS,CUSLEVELDISCOUNT,BRANCH,SALE_TYPE) ";
                    query += "VALUES('" + Convert.ToInt32(VOUCHNUM.Text) + "','" + DOC_NO.Text + "','" + type + "','" + DOC_DATE_GRE.Value.ToString("MM/dd/yyyy") + "','" + DOC_DATE_HIJ.Text + "','" + CURRENCY_CODE.Text + "','" + DOC_REFERENCE.Text + "','" + CUSTOMER_CODE.Text + "','" + CUSTOMER_NAME.Text + "','" + SALESMAN_CODE.Text + "','" + NOTES.Text + "','" + Convert.ToDecimal(TAX_TOTAL.Text) + "','" + Convert.ToDecimal(VATT.Text) + "','" + discount + "','" + Convert.ToDecimal(TOTAL_AMOUNT.Text) + "','" + PAY_CODE.Text + "','" + CARD_NO.Text + "','" + Convert.ToDecimal(txtFreight.Text) + "','" + txtRoundOff.Text + "','" + ((!TXT_CESS.Text.Equals(""))?Convert.ToDecimal(TXT_CESS.Text) : 0) + "','" + chkCustomeleveldiscount.Checked + "','" + lg.Branch + "','" + cmbInvType.SelectedValue + "')";
                }
                else
                {
                 ...
                 //   DeleteTransation(id);
                  //  modifiedtransaction();
                    ...
                    //conn.Open();
                    //reduceStockCommand.CommandText = "SELECT ITEM_CODE, QUANTITY, UOM_QTY, cost_price, supplier_id FROM INV_SALES_DTL WHERE DOC_NO = '" + DOC_NO.Text + "' AND DOC_TYPE = '" + type + "'";
                    ...
                    //        qty = -1 * qty;
                    //    }
                    //    se.addStock(Convert.ToString(r["ITEM_CODE"]), Convert.ToString(qty), Convert.ToString(r["cost_price"]), Convert.ToString(r["supplier_id"]));
                    //}
                    //conn.Close();
                    //---mubarak sir (code)----//
                    status = "Updated!";
                    if (hasBarcode != true)
                    {
                        for (int i = 0; i < dgItems.Rows.Count; i++)
                        {
                            ...
                            if (c["hasbar"].Value != null && c["hasbar"].Value.ToString() == "True")
                            {
                                ...
                                if (Convert.ToInt32(qty) > Convert.ToInt32(dtlQty))
                                {
                                    upStockonProfit(code, Convert.ToInt32(qty) - Convert.ToInt32(dtlQty));
                                }
                                if (Convert.ToInt32(qty) < Convert.ToInt32(dtlQty))
                                {
                                    DownStockonProfit(code, Convert.ToInt32(qty) - Convert.ToInt32(dtlQty));
                                }
                            }
                        }
                    }
                    query = "UPDATE INV_SAL_ORD_HDR SET DOC_ID='" + Convert.ToInt32(VOUCHNUM.Text) + "', DOC_DATE_GRE = '" + DOC_DATE_GRE.Value.ToString("MM/dd/yyyy") + "',DOC_DATE_HIJ = '" + DOC_DATE_HIJ.Text + "',CURRENCY_CODE = '" + CURRENCY_CODE.Text + "',DOC_REFERENCE = '" + DOC_REFERENCE.Text + "',CUSTOMER_CODE = '" + CUSTOMER_CODE.Text + "',CUSTOMER_NAME_ENG = '" + CUSTOMER_NAME.Text + "',SALESMAN_CODE = '" + SALESMAN_CODE.Text + "',NOTES = '" + NOTES.Text + "',TAX_TOTAL = '" + Convert.ToDecimal(TAX_TOTAL.Text) + "',VAT = '" + Convert.ToDecimal(VATT.Text) + "',DISCOUNT = '" + discount + "',TOTAL_AMOUNT = '" + Convert.ToDecimal(TOTAL_AMOUNT.Text) + "',PAY_CODE = '" + PAY_CODE.Text + "',FREIGHT = '" + Convert.ToDecimal(txtFreight.Text) + "',CARD_NO = '" + CARD_NO.Text + "',ROUNDOFF = '" + txtRoundOff.Text + "',CESS = '" + Convert.ToDecimal(TXT_CESS.Text) + "',CUSLEVELDISCOUNT = '" + chkCustomeleveldiscount.Checked + "',SALE_TYPE='" + cmbInvType.SelectedValue + "'  WHERE DOC_NO = '" + DOC_NO.Text + "'";
                    query += "DELETE FROM INV_SAL_ORD_DTL WHERE DOC_NO = '" + DOC_NO.Text + "'";
                    DeleteTransation();

                }
                #region insert sales deatils

                query += "INSERT INTO INV_SAL_ORD_DTL(DOC_TYPE,DOC_ID,DOC_NO,ITEM_CODE,ITEM_DESC_ENG,UOM,PRICE,QUANTITY,ITEM_DISCOUNT,DISC_TYPE,DISC_VALUE,SERIALNO,BRANCH,Pur_Price,hasbar,MRP,FREE";
                ...
                query += ",UOM_QTY, cost_price, supplier_id,group_id";
                query += ")";
                ...
                for (int i = 0; i < dgItems.Rows.Count; i++)
                {
                    ...
                    if (hasBatch)
                    {
                        query += ",'" + c["cBatch"].Value + "','" + DateTime.ParseExact(c["cExpDate"].Value.ToString(), "dd/MM/yyyy", null) + "'";
                    }
                    query += ", '" + c["uomQty"].Value + "', '" + c["cost_price"].Value + "', '" + c["supplier_id"].Value + "', '" + c["uHSNNO"].Value + "'";
                    query += " UNION ALL ";
                 ...
                 //   }
                 ////   stockEntry.addStock(item_id, total_qty.ToString(), c["cost_price"].Value.ToString(), Convert.ToString(c["supplier_id"].Value));
                    //-- MUBARAK SIR CODE---//
                }
                #endregion
                ...
                else
                {
                    ...
                    bool flag = false;
                    DataTable dt = new DataTable();
                    string cmds="SELECT CODE,DESC_ENG,TIN_NO FROM REC_CUSTOMER";
                    //SqlDataAdapter adapter = new SqlDataAdapter(command);
                    //adapter.Fill(dt);
                    dt = DbFunctions.GetDataTable(cmds);
        ...
        public String purcalculation(string code, int qty)
        {
            string ret = "";
            ...
            //cmd.Connection = conn;
            string query = "select Price,Qty,R_Id from RateChange where Item_code='" + code + "'";
            //cmd.CommandType = CommandType.Text;
            //SqlDataAdapter Adap = new SqlDataAdapter();
            //Adap.SelectCommand = cmd;
            DataTable dt = new DataTable();
        ...
        public String barcodePurcal(string code, int qty)
        {
            string ret = "";
            string item_code = code;
            Int32 squantity = qty;
            ...
            Int32 QtyChecker = 0;
            //cmd.Connection = conn;
            string query = "select Price,Qty from RateChange where R_Id='" + code + "'";
           // cmd.CommandType = CommandType.Text;
            //SqlDataAdapter Adap = new SqlDataAdapter();
            //Adap.SelectCommand = cmd;
            DataTable dt = new DataTable();
        ...
        public void PurchaseupStockonProfit(string code, int qty)
        {
           ...
           // Adap.SelectCommand = cmd;
            ...
            if (dt.Rows.Count > 0)
            {
                for (int i = 0; i < dt.Rows.Count && (squantity > 0); ++i)
                {
                    ...
                    totPrice = totPrice + (Convert.ToDecimal(Qty) * Convert.ToDecimal(price));
                    squantity = squantity - Convert.ToInt32(Qty);
                    string upstock = (Convert.ToInt32(tb_qty) - Convert.ToInt32(Qty)).ToString();
                    if (Qty == "0")
                    {
                    ...
                    {
                          cmd1 = "UPDATE RateChange SET Qty='" + upstock + "' where R_Id='" + rid + "'";
                    }
                    //conn.Open();
                    //cmd.Connection = conn;
                    //cmd.CommandType = CommandType.Text;
                    //cmd.ExecuteNonQuery();
                    //conn.Close();
                    DbFunctions.InsertUpdate(cmd1);
                }
            }
        }

        public void upStockonProfit(string code, int qty)
        {
            try
            {
                //SqlCommand cmd1 = new SqlCommand();
                ...
                if (dt.Rows.Count > 0)
                {
                    for (int i = 0; i < dt.Rows.Count && (squantity > 0); ++i)
                    {
                        ...
                        if (Qty != "0")
                        {
                            query1 = "UPDATE RateChange SET Qty='" + upstock + "' where R_Id='" + rid + "'";
                        }
            ...
            if (dt.Rows.Count > 0)
            {
                for (int i = 0; i < dt.Rows.Count && (squantity < 0); ++i)
                {
                    ...
                    if (Convert.ToInt32(tb_qty) != 0)
                    {
                        ...
                        if (Qty == "0")
                        {
                            query = "UPDATE RateChange SET Qty='" + Qty + "' where R_Id='" + rid + "'";
                        }
                        else
                        {

                            query = "UPDATE RateChange SET Qty='" + upstock + "' where R_Id='" + rid + "'";
                        }
                    }
                    //conn.Open();
                    //cmd.CommandType = CommandType.Text;
        ...
        public bool IsActive()
        {
            ...
            //conn.Open();
            //cmd.CommandType = CommandType.Text;
            string query = "SELECT CreditActive FROM REC_CUSTOMER where CODE='" + CUSTOMER_CODE.Text + "'";
            ...
            if (ID == "")
            {
                ...
                if (type == "SAL.CRD" && Convert.ToDecimal(txtcashrcvd.Text) > 0)
                {
                    ...
                    if(PAY_CODE.Text=="CSH")
                        query = "INSERT INTO REC_RECEIPTVOUCHER_HDR (BRANCH,DOC_NO,DOC_DATE_GRE,DOC_DATE_HIJ,CUST_CODE,CUR_CODE,AMOUNT,PAY_CODE,BANK_CODE,CHQ_NO,CHQ_DATE,NOTES,TOTAL_PAID,TOTAL_CURRENT,TOTAL_BALANCE) VALUES('" + branch + "','" + VoucherNumber + "','" + DOC_DATE_GRE.Value.ToString("MM/dd/yyyy") + "','" + DOC_DATE_HIJ.Text + "','" + CUSTOMER_CODE.Text + "','" + CURRENCY_CODE.Text + "','" + txtcashrcvd.Text + "','" + PAY_CODE.Text + "','" + " " + "','" + "" + "','" + "" + "','" + NOTES.Text + "','" + txtcashrcvd.Text + "','" + NET_AMOUNT.Text + "','" + NET_AMOUNT.Text + "')";
                    else if(PAY_CODE.Text=="CHQ")
                        query = "INSERT INTO REC_RECEIPTVOUCHER_HDR (BRANCH,DOC_NO,DOC_DATE_GRE,DOC_DATE_HIJ,CUST_CODE,CUR_CODE,AMOUNT,PAY_CODE,BANK_CODE,CHQ_NO,CHQ_DATE,NOTES,TOTAL_PAID,TOTAL_CURRENT,TOTAL_BALANCE) VALUES('" + branch + "','" + VoucherNumber + "','" + DOC_DATE_GRE.Value.ToString("MM/dd/yyyy") + "','" + DOC_DATE_HIJ.Text + "','" + CUSTOMER_CODE.Text + "','" + CURRENCY_CODE.Text + "','" + txtcashrcvd.Text + "','" + PAY_CODE.Text + "','" + CASHACC.Text + "','" + CARD_NO.Text + "','" + CHQ_DATE.Value.ToString("MM/dd/yyyy") + "','" + NOTES.Text + "','" + txtcashrcvd.Text + "','" + NET_AMOUNT.Text + "','" + NET_AMOUNT.Text + "')";
                    else
                        query = "INSERT INTO REC_RECEIPTVOUCHER_HDR (BRANCH,DOC_NO,DOC_DATE_GRE,DOC_DATE_HIJ,CUST_CODE,CUR_CODE,AMOUNT,PAY_CODE,BANK_CODE,CHQ_NO,CHQ_DATE,NOTES,TOTAL_PAID,TOTAL_CURRENT,TOTAL_BALANCE) VALUES('" + branch + "','" + VoucherNumber + "','" + DOC_DATE_GRE.Value.ToString("MM/dd/yyyy") + "','" + DOC_DATE_HIJ.Text + "','" + CUSTOMER_CODE.Text + "','" + CURRENCY_CODE.Text + "','" + txtcashrcvd.Text + "','" + PAY_CODE.Text + "','" + CASHACC.Text + "','" + CARD_NO.Text + "','" + "" + "','" + NOTES.Text + "','" + txtcashrcvd.Text + "','" + NET_AMOUNT.Text + "','" + NET_AMOUNT.Text + "')";
                    try
                    {
                        //cmd.CommandType = CommandType.Text;
                        //cmd.ExecuteNonQuery();
        ...
        public void printingrecipt()
        {
            try
            {
                ...
                else if (PrintPage.SelectedIndex == 8)
                {
                    ...
                    // Printing.PrintA4();
                    printDocumentHalfSize.DefaultPageSettings.PaperSize = new System.Drawing.Printing.PaperSize("HaldfSize", height + 800, 580);
                    printDialog1.Document = printDocumentHalfSize;
                    printDocumentHalfSize.PrintPage += EstimateHalf_PrintPage;
                    k = 0;
                    tgrossrate = 0; ttaxva = 0; trate = 0; tcdis = 0; ttaxbl = 0; tfree = 0;
                    tqty = 0;
                    // printDocument.Print();
        ...
        public void printingrecipt2()
        {
            ...
            else if (PrintPage.SelectedIndex == 6)
            {
                if (PrintInvoice.Checked)
                {
                    ...
                    height = (dgItems.Rows.Count) * 13;
                    printDocument.DefaultPageSettings.PaperSize = new System.Drawing.Printing.PaperSize("HaldfSize", height + 800, 590);
                    printDocument.PrintPage += printDocumentHalf_PrintPage;
                    printdialog.Document = printDocument;
                    if (chkMultiple.Checked)
                    {
                        if (printdialog.ShowDialog() == DialogResult.OK)
            ...
            else if (PrintPage.SelectedIndex == 8)
            {
                ...
                {
                    height = (dgItems.Rows.Count) * 13;
                    printDocument.DefaultPageSettings.PaperSize = new System.Drawing.Printing.PaperSize("HaldfSize", height + 800, 580);
                    printdialog.Document = printDocument;
                    printDocument.PrintPage += EstimateHalf_PrintPage;
                    if (chkMultiple.Checked)
                    {
                        if (printdialog.ShowDialog() == DialogResult.OK)
                        {
        ...
        private void printGSTPage(PrintPageEventArgs e, String transportMode, String vehicleNumber, String dateOfSupply, String placeOfSupply
            ,String customerName, String customerAddress, String customerGSTTin, String state, String stateCode, String accountNumber, String ifscCode)
        {
            ...
            e.Graphics.DrawString("QUOTATION", printFontBold2, new SolidBrush(Color.Black), 380, 125);
            ...
            e.Graphics.DrawString("Quotation No", Headerfont5, new SolidBrush(Color.Black), 20, 183);
            e.Graphics.DrawString("Quotation Date", Headerfont5, new SolidBrush(Color.Black), 20, 203);
        ...
        public void Getposstions()
        {
            //cmd.Connection = conn;
            //cmd.CommandType = CommandType.Text;
            string cmd = "SELECT * INV_PRINTPOSTION";
            //adapter.SelectCommand = cmd;
            //adapter.Fill(datapositions);
            datapositions = DbFunctions.GetDataTable(cmd);
        }
        ...
        void printDocumentA8B_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            */
            #endregion
            printGSTPage(e, "", "", DOC_DATE_GRE.Value.ToString("dd/MM/yyyy"), "", CUSTOMER_NAME.Text, "", "", cmbState.Text, Convert.ToString(cmbState.SelectedValue), "", "");
        }
        ...
        public void GetSalesMan()
        {
            try
            {
                ...
                SALESMAN_NAME.Text = Convert.ToString(DbFunctions.GetAValueProcedure(cmd,parameter));
                //conn.Close();
                //cmd.CommandType = CommandType.Text;
            }
            catch
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            if (dgItems.Rows.Count > 0 && dgItems.CurrentRow != null && MessageBox.Show("Are you sure to delete the Sales?", "Stock Deletion", MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                ...
                //reduceStockCommand.Connection = conn;
                //conn.Open();
                string query = "SELECT ITEM_CODE, QUANTITY, UOM_QTY, cost_price, supplier_id FROM INV_SALES_DTL WHERE DOC_ID = '" + VOUCHNUM.Text + "' AND DOC_TYPE = '" + type + "'";
                //SqlDataReader r = reduceStockCommand.ExecuteReader();
               ...
               // //cmd.CommandText = "UPDATE  INV_SALES_HDR SET FLAGDEL='FALSE' WHERE DOC_NO ='" + id + "';UPDATE  INV_SALES_DTL SET FLAGDEL='FALSE' WHERE DOC_NO ='" + id + "'";
                string querys = "DELETE FROM INV_SALES_HDR WHERE DOC_NO ='" + id + "';DELETE FROM  INV_SALES_DTL WHERE DOC_NO ='" + id + "'";
                //cmd.ExecuteNonQuery();
                DbFunctions.InsertUpdate(querys);
        ...
        {
            //conn.Open();
           string query = "SELECT Sale_Price from RateChange WHERE R_Id='" + barco + "'";
            string price = Convert.ToString(DbFunctions.GetAValue(query));
            // PRICE.Text = price.ToString();
            if (price != "0")
            {
                double pricedec = Convert.ToDouble(price);
        ...
        public string barcodeConvert(string rcode)
        {
            ...
            //cmd.Connection = conn;
            string query = "SELECT Item_code from RateChange  where R_Id='" + rcode + "'";
            string price = Convert.ToString(DbFunctions.GetAValue(query)); ;
            ret = price;
           // conn.Close();
            return ret;
        ...
        private void BARCODE_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (BARCODE.Text != "")
            {
                if (e.KeyCode == Keys.Enter)
                {
                    ...
                    int len = Convert.ToInt16((co.Length - 1));
                    string Bat = co.Remove(0, 7);
                    DataTable t = General.Product4mBarcode(barcodeConvert(Bat));
                    if (t.Rows.Count > 0)
                    {
        ...
        private void ITEM_NAME_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            else if (e.KeyCode == Keys.Down)
            {
                ...
                if (ITEM_NAME.Text == "" && PNL_DATAGRIDITEM.Visible == false)
                {
                    ...
                    {
                        //conn.Open();
                        string cmd = "SELECT DOC_ID FROM INV_SALES_HDR WHERE DOC_ID = '" + VOUCHNUM.Text + "'AND FLAGDEL='TRUE' AND (SALE_TYPE IS NULL OR SALE_TYPE='')";
                        //cmd.CommandType = CommandType.Text;
                        SqlDataReader r = DbFunctions.GetDataReader(cmd);
                        while (r.Read())
                        {
                            ifDoc_Id = true;
                        }
                    ...
                    else
                    {
                        ...
                        {
                            //conn.Open();
                            string cmd = "SELECT * FROM INV_SALES_HDR WHERE DOC_ID = '" + VOUCHNUM.Text + "'AND FLAGDEL='TRUE' AND SALE_TYPE= '" + cmbInvType.SelectedValue + "'";
                            //cmd.CommandType = CommandType.Text;
                            SqlDataReader r = DbFunctions.GetDataReader(cmd);
                            while (r.Read())
                            {
        ...
        private void ITEM_NAME_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                //conn.Open();
                cmds = "SELECT DOC_ID FROM INV_SALES_HDR WHERE DOC_ID = '" + VOUCHNUM.Text + "'AND FLAGDEL='TRUE' AND (SALE_TYPE IS NULL OR SALE_TYPE='')";
                //cmd.CommandType = CommandType.Text;
                SqlDataReader r = DbFunctions.GetDataReader(cmds);
                while (r.Read())
                {
                    ifDoc_Id = true;
                }
            ...
            {
                //conn.Open();
                cmds = "SELECT * FROM INV_SALES_HDR WHERE DOC_ID = '" + VOUCHNUM.Text + "'AND FLAGDEL='TRUE' AND SALE_TYPE= '" + cmbInvType.SelectedValue + "'";
                //cmd.CommandType = CommandType.Text;
                SqlDataReader r = DbFunctions.GetDataReader(cmds);
                while (r.Read())
                {
        ...
        public void customer(string cus)
        {
            if (!cus.Equals(""))
            {
                string cmd = "SELECT * from REC_CUSTOMER where CODE =" + cus;
                //SqlDataAdapter Adap = new SqlDataAdapter();
                DataTable dt1 = new DataTable();
                //Adap.SelectCommand = cmd1;
                //Adap.Fill(dt1);
                dt1 = DbFunctions.GetDataTable(cmd);
                if (dt1.Rows.Count > 0)
                {
        ...
        public void checkvoucher(int cvouch)
        {
            ...
            if (cmbInvType.SelectedIndex == 0)
            {
                ...
                cmds = "SELECT MAX(DOC_ID) AS Expr1 FROM INV_SAL_ORD_HDR WHERE (SALE_TYPE IS NULL OR SALE_TYPE='') AND FLAGDEL='True'";
                //SqlDataAdapter adapter2 = new SqlDataAdapter(cmd);
                //adapter2.Fill(dt2);
                dt2 = DbFunctions.GetDataTable(cmds);

                DataTable dt3 = new DataTable();
                cmds = "SELECT MIN(DOC_ID) AS Expr1 FROM INV_SAL_ORD_HDR WHERE (SALE_TYPE IS NULL OR SALE_TYPE='') AND FLAGDEL='True'";
                //SqlDataAdapter adapter3 = new SqlDataAdapter(cmd);
                //adapter3.Fill(dt3);
                dt3 = DbFunctions.GetDataTable(cmds);
            ...
            {
                DataTable dt1 = new DataTable();
                cmds="SELECT CODE FROM GEN_SALE_TYPE WHERE DESC_ENG='" + cmbInvType.Text + "'";
                //cmd.CommandType = CommandType.Text;
                //SqlDataAdapter adapter = new SqlDataAdapter(cmd);
                //adapter.Fill(dt1);
                dt1 = DbFunctions.GetDataTable(cmds);

                DataTable dt2 = new DataTable();
                cmds = "SELECT MAX(DOC_ID) AS Expr1 FROM INV_SAL_ORD_HDR WHERE SALE_TYPE='" + cmbInvType.SelectedValue + "' AND FLAGDEL='True'";
                //SqlDataAdapter adapter2 = new SqlDataAdapter(cmd);
                //adapter2.Fill(dt2);
                dt2 = DbFunctions.GetDataTable(cmds);

                DataTable dt3 = new DataTable();
                cmds = "SELECT MIN(DOC_ID) AS Expr1 FROM INV_SAL_ORD_HDR WHERE SALE_TYPE = '" + cmbInvType.SelectedValue + "' AND FLAGDEL='True'";
                //SqlDataAdapter adapter3 = new SqlDataAdapter(cmd);
                //adapter3.Fill(dt3);
                dt3 = DbFunctions.GetDataTable(cmds);

                DataTable dt = new DataTable();
                cmds = "SELECT InvoiceStart FROM GEN_INV_STARTFROM WHERE InvoiceTypeCode='" + dt1.Rows[0][0].ToString() + "'";
                //cmd.CommandType = CommandType.Text;
        ...
        private void btnup_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (cmbInvType.SelectedIndex == 0)
                {
                    cmds = "SELECT * FROM INV_SAL_ORD_HDR WHERE DOC_ID = '" + VOUCHNUM.Text + "' AND FLAGDEL='TRUE' AND (SALE_TYPE IS NULL OR SALE_TYPE='')";
                    //cmd.CommandType = CommandType.Text;
                    //SqlDataAdapter Adap = new SqlDataAdapter();
                    //Adap.SelectCommand = cmd;
                    //Adap.Fill(dt);
                ...
                {
                    cmds = "SELECT * FROM INV_SAL_ORD_HDR WHERE DOC_ID = '" + VOUCHNUM.Text + "' AND FLAGDEL='TRUE' AND SALE_TYPE='" + cmbInvType.SelectedValue + "'";
                    //cmd.CommandType = CommandType.Text;
                    //SqlDataAdapter Adap = new SqlDataAdapter();
                    //Adap.SelectCommand = cmd;
                    //Adap.Fill(dt);
                ...
                {                    
                        ...
                        //conn.Open();
                        ////cmd.CommandText = "SELECT dtl.*, PAY_SUPPLIER.DESC_ENG AS supplier_name FROM INV_SALES_DTL as dtl LEFT JOIN PAY_SUPPLIER ON dtl.supplier_id = PAY_SUPPLIER.CODE WHERE DOC_NO = '" + DOC_NO.Text + "'AND FLAGDEL='TRUE'";
                        string query = "SELECT dtl.*, PAY_SUPPLIER.DESC_ENG AS supplier_name, g.DESC_ENG AS [Group] FROM INV_SAL_ORD_DTL as dtl LEFT JOIN PAY_SUPPLIER ON dtl.supplier_id = PAY_SUPPLIER.CODE LEFT JOIN INV_ITEM_GROUP as g ON dtl.group_id = g.CODE WHERE DOC_NO = '" + DOC_NO.Text + "'AND FLAGDEL='TRUE'";
                        //cmd.CommandType = CommandType.Text;
                        SqlDataReader r = DbFunctions.GetDataReader(query);
                        while (r.Read())
                        {
        ...
        private void btndown_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (cmbInvType.SelectedIndex == 0)
                {
                    query = "SELECT * FROM INV_SAL_ORD_HDR WHERE DOC_ID = '" + VOUCHNUM.Text + "'AND FLAGDEL='TRUE' AND (SALE_TYPE IS NULL OR SALE_TYPE='')";
                    //cmd.CommandType = CommandType.Text;
                    //SqlDataAdapter Adap = new SqlDataAdapter();
                   // Adap.SelectCommand = cmd;
                    //Adap.Fill(dt);
                ...
                {
                    query = "SELECT * FROM INV_SAL_ORD_HDR WHERE DOC_ID = '" + VOUCHNUM.Text + "'AND FLAGDEL='TRUE' AND SALE_TYPE= '" + cmbInvType.SelectedValue + "'";
                   // md.CommandTypec = CommandType.Text;
                    //SqlDataAdapter Adap = new SqlDataAdapter();
                    //Adap.SelectCommand = cmd;
                    //Adap.Fill(dt);
                    dt=DbFunctions.GetDataTable(query);
                ...
                {                   
                        ...
                        //conn.Open();
                        ///cmd.CommandText = "SELECT dtl.*, PAY_SUPPLIER.DESC_ENG AS supplier_name FROM INV_SALES_DTL as dtl LEFT JOIN PAY_SUPPLIER ON dtl.supplier_id = PAY_SUPPLIER.CODE WHERE DOC_NO = '" + DOC_NO.Text + "'AND FLAGDEL='TRUE'";
                        query = "SELECT dtl.*, PAY_SUPPLIER.DESC_ENG AS supplier_name, g.DESC_ENG AS [Group] FROM INV_SAL_ORD_DTL as dtl LEFT JOIN PAY_SUPPLIER ON dtl.supplier_id = PAY_SUPPLIER.CODE LEFT JOIN INV_ITEM_GROUP as g ON dtl.group_id = g.CODE WHERE DOC_NO = '" + DOC_NO.Text + "'AND FLAGDEL='TRUE'";
                        //cmd.CommandType = CommandType.Text;
                        SqlDataReader r = DbFunctions.GetDataReader(query);
                        while (r.Read())
                        {
        ...
        {
            //conn.Open();
            string query = "UPDATE tbl_CreditNote SET  Status='Inactive'  WHERE CN_Doc_No = '" + txtCreditNoteNo.Text + "' ";
            //cmd.CommandType = CommandType.Text;
            //cmd.ExecuteNonQuery();
            //conn.Close();
            DbFunctions.InsertUpdate(query);
        ...
        private void txtCreditNoteNo_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter || e.KeyCode == Keys.Tab)
            {
                ...
                {
                    DataTable dt = new DataTable();
                    string cmd = "SELECT * FROM tbl_CreditNote WHERE CN_Doc_No = '" + txtCreditNoteNo.Text + "'";
                    //cmd.CommandType = CommandType.Text;
                    //SqlDataAdapter Adap = new SqlDataAdapter();
                    //Adap.SelectCommand = cmd;
                   // Adap.Fill(dt);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (itemAddValid())
            {
                ...
                Dictionary<string, object> parameter = new Dictionary<string, object>();
                parameter.Add("@item_id", CODE.Text);
                parameter.Add("@qty", 0);
                parameter.Add("@cost_price", ba.pr);
                parameter.Add("@mrp", ba.mrp);
                string sup_id = "";
                parameter.Add("@supplier_id", sup_id);
                parameter.Add("@batch_id", next_batch);
                parameter.Add("@batch_increment", next_batch_inc);
        ...
        private void VOUCHNUM_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter && !VOUCHNUM.Text.Equals(""))
            {
                ...
                if (cmbInvType.SelectedIndex == 0)
                {
                    query = "SELECT * FROM INV_SALES_HDR WHERE DOC_ID = '" + VOUCHNUM.Text + "'AND FLAGDEL='TRUE' AND (SALE_TYPE IS NULL OR SALE_TYPE='')";
                    //cmd.CommandType = CommandType.Text;
                    //SqlDataAdapter Adap = new SqlDataAdapter();
                    //Adap.SelectCommand = cmd;
                    //Adap.Fill(dt);
                ...
                {
                    query = "SELECT * FROM INV_SALES_HDR WHERE DOC_ID = '" + VOUCHNUM.Text + "'AND FLAGDEL='TRUE' AND SALE_TYPE= '" + cmbInvType.SelectedValue + "'";
                    //cmd.CommandType = CommandType.Text;
                    //SqlDataAdapter Adap = new SqlDataAdapter();
                    //Adap.SelectCommand = cmd;
                    //Adap.Fill(dt);
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    //conn.Open();
                    query = "SELECT * FROM INV_SALES_DTL WHERE DOC_NO = '" + DOC_NO.Text + "'AND FLAGDEL='TRUE'";
                    //cmd.CommandType = CommandType.Text;
                    SqlDataReader r = DbFunctions.GetDataReader(query);
                    while (r.Read())
                    {
        ...
        private void cmbInvType_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (!VOUCHNUM.Text.Equals(""))
            {
                checkvoucher(Convert.ToInt32(VOUCHNUM.Text));
                DataTable dt = new DataTable();
                string cmd = "SELECT * FROM INV_SAL_ORD_HDR WHERE DOC_ID = '" + VOUCHNUM.Text + "' AND FLAGDEL='TRUE' AND SALE_TYPE='" + cmbInvType.SelectedValue + "'";
                //cmd.CommandType = CommandType.Text;
                //SqlDataAdapter Adap = new SqlDataAdapter();
                //Adap.SelectCommand = cmd;
                //Adap.Fill(dt);
                ...
                cmd = "SELECT * FROM INV_SAL_ORD_DTL WHERE DOC_NO = '" + DOC_NO.Text + "'AND FLAGDEL='TRUE'";
                //cmd.CommandType = CommandType.Text;
                //conn.Open();
                SqlDataReader r = DbFunctions.GetDataReader(cmd);
                while (r.Read())
        ...
        {
            DataTable dt = new DataTable();
            string cmd = "SELECT DISTINCT LEDGERNAME FROM tb_Ledgers WHERE UNDER IN (10,21,22)";
            //SqlDataAdapter adapter = new SqlDataAdapter(cmd);
            //adapter.Fill(dt);
            dt = DbFunctions.GetDataTable(cmd);
        ...
        private void DOC_REFERENCE_TextChanged(object sender, EventArgs e)
        {

        }

        private void krtb_post_Click(object sender, EventArgs e)
        {
            string ccode, cname, netamt, tamt, disc, qno;
            ccode = CUSTOMER_CODE.Text;
            cname = CUSTOMER_NAME.Text;
            netamt = NET_AMOUNT.Text;
            tamt = TOTAL_AMOUNT.Text;
            disc = DISCOUNT.Text;
            qno = VOUCHNUM.Text;
            SalesQ sal = new SalesQ(ccode, cname, netamt, tamt, disc, qno);
            sal.Show();
            post();
        }
        public void post()
        {
            string cmd = "UPDATE INV_SALE_ORD_HDR SET POST='Y'  WHERE  DOC_ID='" + VOUCHNUM.Text + "'";
            //conn.Open();
            //cmd.CommandType = CommandType.Text;
            try
            {
