...
namespace Sys_Sols_Inventory.Model
{
    class TransactionPaymentTEMP
    {
        ...
        public TransactionPaymentTEMP()
        {

        }
        public TransactionPaymentTEMP(TransactionHeaderTEMP transhead, string paymentmethod, string paymentcurrency, float paymentamount)
        {
        ...
        public static int VoidPayment(TransactionPayment payment)
        {
            ...
            Dictionary<string, object> parameters = new Dictionary<string, object>();
            parameters.Add("@ShiftNo", payment.ShiftNo);
            parameters.Add("@Branch", payment.Branch);
            parameters.Add("@TillID", payment.TillID);
            parameters.Add("@TransactionNo", payment.TransactionNo);
            parameters.Add("@LineNo", payment.LineNo);
