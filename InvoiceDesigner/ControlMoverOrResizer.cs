...
namespace Sys_Sols_Inventory
{
    internal class ControlMoverOrResizer
    {
        ...
        internal static void UndoInit(Control control)
        {
            UnInit(control, control);
        }
        internal static void Init(Control control, Control container)
        {
            ...
            control.KeyDown+= (sender, e) => MoveControlkeydown(container, e);
        }
        internal static void UnInit(Control control, Control container)
        {
            _moving = false;
            _resizing = false;
            _moveIsInterNal = false;
        ...
        private static void MoveControlkeydown(Control control, KeyEventArgs e)
        {
            if (WorkType == MoveOrResize.stop)
                return;
